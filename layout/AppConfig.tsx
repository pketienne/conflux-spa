                ...
                <div className="px-2">
                    ...
                    <div className="flex">
                        <div className="field-radiobutton flex-auto">
                            <RadioButton name="colorScheme" value="light" checked={layoutConfig.colorScheme === 'light'} onChange={(e) => changeColorScheme(e.value)}></RadioButton>
                            <label htmlFor="theme3">Light</label>
                        </div>

                        <div className="field-radiobutton flex-auto">
                            <RadioButton name="colorScheme" value="dark" checked={layoutConfig.colorScheme === 'dark'} onChange={(e) => changeColorScheme(e.value)}></RadioButton>
                    ...
                    {!props.minimal && (
                        <>
                            ...
                            <div className="flex flex-wrap row-gap-3">
                                ...
                                <div className="flex align-items-center gap-2 w-6">
                                    <RadioButton name="menuMode" value="compact" checked={layoutConfig.menuMode === 'slim-plus'} inputId="mode4" onChange={(e) => changeMenuMode(e)}></RadioButton>
                            ...
                            <div className="flex flex-wrap row-gap-3">
                                <div className="flex align-items-center gap-2 w-6">
                                    <RadioButton
                                        ...
                                        disabled={layoutConfig.colorScheme === 'dark' || isHorizontal()}
