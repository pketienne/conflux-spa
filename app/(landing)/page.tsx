			...
			<div className={wrapperClassName}>
				...
				<div className="flex align-items-center justify-content-between relative lg:static py-6 mx-0 px-4 lg:py-6">
					...
					<ul
						...
						className="list-none flex-grow-1 justify-content-end hidden md:flex absolute md:relative h-screen md:h-auto surface-card md:surface-ground m-0 z-5 w-full sm:w-6 md:w-full py-6 md:py-0"
					>
						...
						<li>
							<StyleClass nodeRef={customizationsButtonRef as NodeRef} selector="@grandparent" enterClassName="hidden" enterActiveClassName="px-fadein" leaveToClassName="hidden">
								<a
									href="#customizations"
									ref={customizationsButtonRef}
									className="flex m-0 md:ml-5 md:px-0 px-3 py-3 text-900 font-medium line-height-3 hover:text-primary cursor-pointer"
									onClick={() => scrollToElement(customizationsRef)}
								>
						...
						<li className="flex align-items-center">
							<StyleClass nodeRef={buttonRef as NodeRef} selector="@grandparent" enterClassName="hidden" enterActiveClassName="px-fadein" leaveToClassName="hidden">
								<Button onClick={navigateToLogin} type="button" label="Login" className="m-0 mt-3 md:mt-0 ml-3 md:ml-5"></Button>
							</StyleClass>
						</li>
					</ul>
				</div>
				<div ref={homeRef} id="home" className="landing-banner px-4 md:px-8 py-8 lg:flex flex-wrap">
					<div className="banner-left w-full lg:w-8">
						...
						<h4 className="font-normal text-900 m-0 mb-6 line-height-3 w-10" style={{ letterSpacing: '0.6px' }}>
							Say goodbye to clunky, outdated dashboards and hello to modern, user-friendly design. With an array of pages and components at your fingertips, building your business dashboard has never been easier. Start streamlining
							your operations and making data-driven decisions with FREYA today!
						</h4>
					...
					<div className="section-top lg:flex w-full gap-6 align-items-center mb-6">
						...
						<div className="lg:w-4 lg:mt-0 mt-5">
							<h3 className="font-normal text-900 m-0 mb-6 w-full" style={{ letterSpacing: '0.6px' }}>
								With customizability at the forefront, our templates can be tailored to your specific needs and preferences. Whether you&lsquo;re looking for a simple and intuitive interface or a more complex and feature-rich
								solution, our templates have you covered.
							</h3>
					...
					<div className="content lg:flex justify-content-between gap-6">
						<div className="left lg:w-6">
							<h4 className="w-11 font-normal text-900 m-0 mb-6 line-height-3" style={{ letterSpacing: '0.6px' }}>
								Streamline your project building process and save valuable time with the ready-to-use applications offered by <b className="font-medium">FREYA</b>. From Chat to Mail, Product Reviews, Checkout and more, our suite of
								pre-made tools will have you up and running in no time. Start fast-tracking your success and take advantage of the time-saving features of <b className="font-medium">FREYA today.</b>
							</h4>
							<ul className="list-none p-0 m-0">
								<li className="mb-4 flex align-items-center">
									<a
										onMouseOver={() => changeImageOnHover(0)}
										style={{ color: activeLink == 0 ? 'var(--primary-color) !important' : '' }}
										className="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
									>
										Chat{' '}
									</a>
								...
								<li className="mb-4 flex align-items-center">
									<a
										onMouseOver={() => changeImageOnHover(1)}
										style={{ color: activeLink == 1 ? 'var(--primary-color) !important' : '' }}
										className="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
									>
										Mail
									</a>
								...
								<li className="mb-4 flex align-items-center">
									<a
										onMouseOver={() => changeImageOnHover(2)}
										style={{ color: activeLink == 2 ? 'var(--primary-color) !important' : '' }}
										className="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
									>
										Task List
									</a>
								...
								<li className="mb-4 flex align-items-center">
									<a
										onMouseOver={() => changeImageOnHover(3)}
										style={{ color: activeLink == 3 ? 'var(--primary-color) !important' : '' }}
										className="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer"
									>
										Blog
									</a>
